  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        title="Review Survey"
        className="px-3 py-1.5 text-xs font-medium rounded-lg border border-gray-200 text-gray-700 hover:bg-gray-50 flex flex-col items-center gap-0.5 transition-colors cursor-pointer active:scale-95 select-none min-w-[52px]"
      >
      ...
      <button
        ...
        className="px-3 py-1.5 rounded-lg border border-blue-200 text-blue-600 hover:bg-blue-50 flex flex-col items-center gap-0.5 transition-colors cursor-pointer active:scale-95 select-none disabled:opacity-50 min-w-[52px]"
      >
      ...
      <button
        ...
        className={`px-3 py-1.5 text-xs font-semibold rounded-lg border flex flex-col items-center gap-0.5 transition-colors disabled:opacity-50 cursor-pointer active:scale-95 select-none min-w-[52px] ${
          status === 'PUBLISHED'
      ...
      <div className="relative">
        <button
          ...
          title="Share Survey"
          className="px-3 py-1.5 rounded-lg border border-blue-200 text-blue-600 hover:bg-blue-50 flex flex-col items-center gap-0.5 transition-colors cursor-pointer active:scale-95 select-none min-w-[52px]"
        >
