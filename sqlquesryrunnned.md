alter policy "Public can read published surveys"
on surveys
using (status in ('PUBLISHED','DRAFT'));

drop policy "Public can read questions of published surveys" on questions;
create policy "Public can read questions of published or draft surveys" on questions
for select
to anon
using (
  exists (
    ...
    and surveys.status in ('PUBLISHED','DRAFT')
  )
);


insert into admins (id, email, role)
values ('4f4c18af-5777-476a-aa15-d59570ed3dab', 'rahuljaiswarofficial@gmail.com', 'SUPER_ADMIN')
